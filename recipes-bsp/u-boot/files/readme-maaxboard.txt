...
## MaaXBoard Configure Options
+-------------------+------------------+-------------------------------+
| options           | value can be set | dtbo to be loading            |
+-------------------+------------------+-------------------------------+
| dtoverlay_camera  | ov5640, as0260   | camera-{ov5640,as0260}.dtbo   |
+-------------------+------------------+-------------------------------+
| dtoverlay_display | mipi, hdmi, dual | display-{mipi,hdmi,dual}.dtbo |
+-------------------+------------------+-------------------------------+
| dtoverlay_usb0    | '1' or 'yes'     | usb0-device.dtbo              |
+-------------------+------------------+-------------------------------+
| dtoverlay_gpio    | '1' or 'yes'     | ext-gpio.dtbo                 |
+-------------------+------------------+-------------------------------+
| dtoverlay_i2c     | '2', '3', '2 3'  | ext-i2c{2,3}.dtbo             |
+-------------------+------------------+-------------------------------+
| dtoverlay_pwm     | '2', '4', '2 4'  | ext-pwm{2,4}.dtbo             |
+-------------------+------------------+-------------------------------+
| dtoverlay_spi     | '1'              | ext-spi1.dtbo                 |
+-------------------+------------------+-------------------------------+
| dtoverlay_uart    | '2'              | ext-uart2.dtbo                |
+-------------------+------------------+-------------------------------+
| dtoverlay_wm8960  | '1' or 'yes'     | ext-wm8960.dtbo               |
+-------------------+------------------+-------------------------------+
| dtoverlay_extra   | Other dtbo files to be loading, such as xxx.dtbo |
+-------------------+--------------------------------------------------+
| fdt_file          | Board base dtb file, should be maaxboard.dtb     |
+-------------------+--------------------------------------------------+

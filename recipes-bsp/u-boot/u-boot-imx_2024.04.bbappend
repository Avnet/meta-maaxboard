...
UBOOT_BRANCH:maaxboard8ulp = "maaxboard_lf-6.6.36-2.1.0"
UBOOT_BRANCH:maaxboardosm93 = "maaxboard_lf-6.6.52-2.2.0"
        ...
        for config in ${UBOOT_MACHINE}; do
            ...
            for type in ${UBOOT_CONFIG}; do
                ...
                then
                    ...
                    install -m 0777 ${B}/${config}/arch/arm/dts/${MACHINE}.dtb  ${DEPLOYDIR}/${BOOT_TOOLS}

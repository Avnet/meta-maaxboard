...
usage(){
    ...
    echo "  * [-h]: help"
    echo "Examples: "
    echo "$ MACHINE=maaxboard source sources/meta-maaxboard/tools/maaxboard-setup.sh -b maaxboard/build"
...
maaxboard_conf_set(){
    ...
    elif [ $MACHINE == "maaxboard-nano" ];then
